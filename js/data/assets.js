...
const HBA_UI_ASSETS = Object.freeze({
  logoProjeto: 'assets/hba-legacy-logo.png',
  bandeiraBrasil: '',
...
window.HBAAssets = Object.freeze({
  times: NBA_TEAM_ASSETS,
  interface: HBA_UI_ASSETS,
  obterAssetTime: obterAssetTime,
  obterAssetsInterface: obterAssetsInterface
});
